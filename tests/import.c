...
int main(void) {
	...
	param = hilbert_module_import(dest, src, 0, NULL, NULL, &errcode);
	...
	HilbertHandle s2param = hilbert_module_import(dest, src2, 0, NULL, NULL, &errcode);
	if (errcode != 0) {
	...
	HilbertHandle sparam = hilbert_module_import(dest, src, 0, NULL, NULL, &errcode);
